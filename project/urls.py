...
from company.views import EmployeeView , EmployeeView2 ,EmployeeClassView ,TeamView ,TeamView2 ,TeamClassView
...
urlpatterns = [
    ...
    path("",EmployeeView ,name="EmpolyeeView"),
    path("emp/",EmployeeView2 ,name="EmpolyeeView2"),
